...
public class FleetCloudTest {
    ...
    private MockedStatic<Fleets> mockedFleets;
    ...
    public void before() {
        ...
        mockedFleets = Mockito.mockStatic(Fleets.class);
        mockedFleets.when(() -> Fleets.get(anyString())).thenReturn(fleet);
    ...
    public void provision_shouldProvisionNoneWhenMaxReached() {
        ...
        Mockito.when(fleet.getState(anyString(), anyString(), anyString(), anyString()))
    ...
    public void update_shouldAddNodeWithScaledToOneNumExecutors_whenWeightPresentButLessOneAndEnabled() {
        ...
        Mockito.doThrow(new UnsupportedOperationException("Test exception")).when(fleet)
    ...
    public void update_givenFleetInModifyingShouldNotDoAnyUpdates() throws IOException {
        ...
        final FleetStateStats stats = new FleetStateStats("fleetId", 0,
                ...
                Collections.singleton(instanceId),
                Collections.singletonMap(instanceType, .1));
        Mockito.when(fleet.getState(anyString(), anyString(), anyString(), anyString())).thenReturn(stats);
    ...
    public void descriptorImpl_doFillFleetItems_returnFleetsProvidedByAllFleets() {
        ...
        mockedFleets.when(Fleets::all).thenReturn(Arrays.asList(ec2SpotFleet, autoScalingGroupFleet));
